...
<button type="button" class="add_phone">Add Telephone Number With Name </button>
<form id="txt_form" name="txt_form" type="post">
<div class="col-lg-6">
...
<button class="btn btn-sm btn-info btn_click" type="button">Submit</button> &nbsp;&nbsp;
		<button type="button" class="btn btn-default btn-sm clear_show">Close</button>
</div>
 </form>
	...
	<script>
	$(".clear_show").on("click",function(e){
		$(".name_value").html("");
		$(".number_value").html("");
		$("#txt_name1").val("");
		$("#txt_mo1").val("");
